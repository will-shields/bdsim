...
struct Element {
  ...
  double l,ks,k0,k1,k2,k3,angle,beampipeThickness,aper,aperX, aperY, tilt,xsize,ysize,r,outR,hgap,B, phiAngleIn, phiAngleOut, tscint, screenPSize, windowScreenGap, twindow, tmount,  bmapZOffset, magnetOffsetX; // l in meter
