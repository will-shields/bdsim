...
PerEntryHistogramSetPlane::~PerEntryHistogramSetPlane()
{;}

void PerEntryHistogramSetPlane::CheckSampler()
{
  if (!sampler)
    {
...
void PerEntryHistogramSetPlane::GetPDGIDSetFromSampler(std::set<long long int>& setIn) const
{
