if (USE_AFS AND NOT CLHEP_LIBRARY_DIR)
   ...
   elseif (RHL6)
     set(CLHEP_INCLUDE_DIR /afs/cern.ch/sw/lcg/app/releases/GEANT4/clhep/2.3.1.0/x86_64-slc6-gcc49-opt/include)
     set(CLHEP_LIBRARY_DIR /afs/cern.ch/sw/lcg/app/releases/GEANT4/clhep/2.3.1.0/x86_64-slc6-gcc49-opt/lib)
   endif()
else()
   if($ENV{VERBOSE})
