...
class BDSMagInt_Driver : public G4VIntegrationDriver
{
public:  // with description

    BDSMagInt_Driver(G4double hminimum,
                    G4MagIntegratorStepper* pItsStepper,
                    G4int numberOfComponents = 6,
                    G4int statisticsVerbosity = 1);
    virtual ~BDSMagInt_Driver() override;
    // Constructor, destructor.

    BDSMagInt_Driver(const BDSMagInt_Driver&) = delete;
    BDSMagInt_Driver& operator=(const BDSMagInt_Driver&) = delete;
...
#include "BDSMagIntegratorDriver.icc"

#endif /* BDSMagInt_Driver_Def */
