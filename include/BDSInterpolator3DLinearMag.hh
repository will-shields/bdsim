...
*/
#ifndef BDSINTERPOLATE3DLINEARMAG_H
#define BDSINTERPOLATE3DLINEARMAG_H
...
/** 
 * @brief Linear interpolation over 3d array including magnitude interpolation.
 * 
...
class BDSInterpolator3DLinearMag: public BDSInterpolator3D
{
public:
  explicit BDSInterpolator3DLinearMag(BDSArray3DCoords* arrayIn);
  virtual ~BDSInterpolator3DLinearMag();
