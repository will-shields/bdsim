...
public: // with description
    BDSPSCellFlux4D(G4String name, const BDSHistBinMapper* mapperIn,
    G4int ni=1,G4int nj=1, G4int nk=1, G4int nl=1,
            G4int depi=2, G4int depj=1, G4int depk=0, G4int depl=1);
    BDSPSCellFlux4D(G4String name, const BDSHistBinMapper* mapperIn, const G4String& unit,
            G4int ni=1,G4int nj=1, G4int nk=1, G4int nl=1,
            G4int depi=2, G4int depj=1, G4int depk=0, G4int depl=1);
...
private:
    G4int fDepthi, fDepthj, fDepthk, fDepthl, fNl;
