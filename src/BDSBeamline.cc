							      ...
							      G4int               index) const
{
  ...
  G4ThreeVector     elPosStart = element->GetPositionStart() - G4ThreeVector(0,0,pl);
  G4ThreeVector positionMiddle = elPosStart - G4ThreeVector(0,0,endPieceLength).transform(*elRotStart);
							     ...
							     G4bool              flip) const
{
  ...
  G4ThreeVector       elPosEnd = element->GetPositionEnd() + G4ThreeVector(0,0,pl);;
