...
BDSIntegrator::BDSIntegrator(G4Mag_EqRhs* eqOfMIn,
			     G4int        nVariablesIn):
...
BDSIntegrator::~BDSIntegrator()
{
  delete backupStepper;
}

void BDSIntegrator::AdvanceDrift(const G4double yIn[],
...
void BDSIntegrator::AdvanceChord(const G4double h,
