				       ...
				       G4double       yErr[])
{
  ...
  BDSStep localCL   = GlobalToCurvilinear(strength, pos, mom, h, false);
  BDSStep globalOut = CurvilinearToGlobal(strength, localCL.PreStepPoint(), localCL.PostStepPoint(), false);
