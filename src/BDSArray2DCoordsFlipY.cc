...
G4bool BDSArray2DCoordsFlipY::OutsideCoords(G4double x,
					    G4double y,
					    G4double z,
					    G4double t) const
{
...
G4double BDSArray2DCoordsFlipY::ArrayCoordsFromX(G4double x) const
{
  return (x + xMax) / xStep;
}

G4int BDSArray2DCoordsFlipY::NearestX(G4double x) const
{
  return (G4int)round((x+xMax)/xStep);
}

const BDSFieldValue& BDSArray2DCoordsFlipY::GetConst(G4int x,
						     G4int y,
						     G4int z,
						     G4int t) const
{
...
G4bool BDSArray2DCoordsFlipY::Outside(G4int x,
				      G4int y,
				      G4int z,
				      G4int t) const
{
