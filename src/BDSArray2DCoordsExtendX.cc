...
G4bool BDSArray2DCoordsExtendX::OutsideCoords(G4double x,
					      G4double y,
					      G4double z,
					      G4double t) const
{
...
G4double BDSArray2DCoordsExtendX::ArrayCoordsFromY(G4double y) const
{
  return (y + yMax) / yStep;
}

G4int BDSArray2DCoordsExtendX::NearestY(G4double y) const
{
  return (G4int)round((y+yMax)/yStep);
}

const BDSFieldValue& BDSArray2DCoordsExtendX::GetConst(G4int x,
						       G4int y,
						       G4int z,
						       G4int t) const
{
...
G4bool BDSArray2DCoordsExtendX::Outside(G4int x,
					G4int y,
					G4int z,
					G4int t) const
{
