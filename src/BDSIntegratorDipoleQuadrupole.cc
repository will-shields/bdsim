					    ...
					    G4double       yErr[6])
{
  ...
  BDSStep       localCL     = GlobalToCurvilinear(strength, globalPos, globalMom, h, true, fcof);
  ...
  BDSStep globalOut = CurvilinearToGlobal(strength, localCLPosOut, localCLMomOut, true, fcof);
